...
<a href="{{ url('admin/destination') }}" class="btn btn-default btn-sm backlink"><i class="fa fa-list" aria-hidden="true"></i> Show List </a>
@endsection

@section('content')
<form class="form-horizontal" role="form" action="{{ url('admin/destination/'.$data->id) }}" method="post" enctype="multipart/form-data">
  {{ csrf_field() }}    
  ...
  <div class="col-md-9">
    ...
    <div class="panel">
      <div class="panel-heading">
        <span class="panel-title">New Destinations </span>
      </div>
    ...
    <div class="panel-body">
      ...
      <div class="form-group">
        ...
        <div class="col-lg-9">
          <div class="bs-component">
            <input type="text" id="" name="meta_key" class="form-control" value="{{$data->meta_keyword}}" placeholder="Meta Key" />
          </div>
        </div>
      </div>
    ...
    <div class="sid_bvijay mb10">
      ...
      <div class="hd_show_con">
        ...
        <span class="id{{$data->id}}">
          ...
          <img src="{{asset(env('PUBLIC_PATH').'uploads/original/'.$data->thumbnail)}}" width="30%" />
        </span>
        <hr/>
        @endif
        <div id="xedit-demo">
...
<script type="text/javascript">
  ...
  $('.imagedelete').on('click',function(e){
    ...
    $.ajax({
      type:'delete',
      url:"{{url('delete_destination_thumb') . '/'}}" + id,
      data:{_token:csrf},    
