            ...
            <div class="card">
              ...
              <div class="card-body">
                <div class="tab-content">
                  ...
                  @include('admin.team.edit.edit-mountains')
                  </div>
                  <!-- /.tab-pane -->
                  <div class="tab-pane" id="tab_3">
                  @include('admin.team.edit.edit-achievements')
                  </div>
                  <!-- /.tab-pane -->
   ...
   jQuery(document).delegate('button.delete-mountain', 'click', function(e) {
     ...
     if (makeConfirm == true) {
      ...
      // For delete mountain individually.              
        ...
        var team_id = '{{$data->id}}';
        var url = '{{ route("mountains.destroy",["id"=>':id',"info_id"=>':info_id']) }}';
          url = url.replace(':id',team_id);
   ...
   jQuery(document).delegate('button.delete-achievement', 'click', function(e) {
     ...
     if (makeConfirm == true) {
      ...
      // For delete achievement individually.              
        ...
        var team_id = '{{$data->id}}';
        var url = '{{ route("achievements.destroy",["id"=>':id',"info_id"=>':info_id']) }}';
          url = url.replace(':id',team_id);
