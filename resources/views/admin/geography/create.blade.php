...
@section('title','Post Geographical Facts')
@section('breadcrumb')
    <a href="{{ route('facts')}}" class="btn btn-primary btn-sm">List</a>
@endsection
@section('content')
    <form class="form-horizontal" role="form" action="{{ route('facts-post') }}" method="post" enctype="multipart/form-data">
        {{ csrf_field() }}
        <div class="col-md-8">
            <!-- Input Fields -->
            <div class="panel">
                <div class="panel-heading">
                    <span class="panel-title">Geographical facts </span>
                </div>
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <div class="bs-component">
                                <input type="text" id="cat_uri" name="alt" class="form-control" placeholder="" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <div class="bs-component">
                                <input type="text" id="caption" name="countries" class="form-control" placeholder="" />
                            </div>
                        </div>
                    </div>
                    ...
                    <!--    <div class="col-lg-8">-->
                    <!--        <div class="bs-component">-->
                    <!--            <input class="form-control" name="lat_sym" type="text" placeholder="">-->
                    <!--        </div>-->
                    <!--    </div>-->
                    <!--</div>-->
                    ...
                    <!--    <div class="col-lg-8">-->
                    <!--        <div class="bs-component">-->
                    <!--            <input class="form-control" name="long_sym" type="text" placeholder="">-->
                    <!--        </div>-->
                    <!--    </div>-->
                    <!--</div>-->
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <div class="bs-component">
                                <input class="form-control" name="rp" type="text" placeholder="">
                            </div>
                        </div>
                    </div>
