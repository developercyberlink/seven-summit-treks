...
@section('breadcrumb')
<a href="{{ url('admin/circulartype/'.Request::segment(3).'/create') }}" class="btn btn-primary btn-sm">Create</a>
@endsection
          ...
          <tbody>
            ...
            <tr class="id{{$row->id}}">
              ...
              <td class="post_title title_hi_sh">
                ...
                <div class="row_actions"><span class="id">ID: {{$row->id}} | </span><span class="edit"><a href="{{ 'admin/circulartype/' . Request::segment(3) .'/'. $row->id. '/edit'}}" aria-label="">Edit</a> | </span>
