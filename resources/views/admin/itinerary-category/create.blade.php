...
@section('title', '')
@section('breadcrumb')
<a href="{{ route('category.index',$id) }}" class="btn btn-primary btn-sm">List</a>
@endsection
@section('content')
            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header d-flex p-0">
                        <h3 class="card-title p-3">{{$trip->trip_title}} Itineraries</h3>
                    ...
                    <div class="card-body">
                        <div class="tab-content">
                            ...
                            <div class="tab-pane" id="tab_2">
                                @include('admin.itinerary-category.create-itinerary')
                            </div>

                            <div class="tab-pane" id="tab_3">
                                @include('admin.itinerary-category.cost-include')
                            </div>

                            <div class="tab-pane" id="tab_4">
                                @include('admin.itinerary-category.cost-exclude')
                            </div>
                            <!-- /.tab-pane -->
                        </div>
                        <!-- /.tab-content -->
...
@section('scripts')
    ...
    $(function() {
        ...
        $("#tripData").on('submit', function(e) {
            e.preventDefault();
            let url = "{{ route('itinerary-category.store') }}";
