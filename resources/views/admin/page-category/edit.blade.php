...
@section('breadcrumb')
<a href="{{ url('admin/pagecategory') }}" class="btn btn-primary btn-sm">List</a>
@endsection
@section('content')

<form class="form-horizontal" role="form" action="{{ url('admin/pagecategory', $data->id) }}" method="post" enctype="multipart/form-data">
 {{ csrf_field() }}            
 ...
 <div class="col-md-8">
  ...
  <div class="panel">
    <div class="panel-heading">
      <span class="panel-title">Create Page Category</span>
    </div>
...
@endsection
  ...
  <script type="text/javascript">
   // Delete Thumb
    ...
    $.ajax({
      type:'DELETE',
      url:"{{url('delete_pagecategory_thumb') . '/'}}" + id,
      data:{_token:csrf},    
