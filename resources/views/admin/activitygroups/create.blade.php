...
@section('content')
<form class="form-horizontal" role="form" action="{{ url('admin/activitygroup') }}" method="post" enctype="multipart/form-data">
  {{ csrf_field() }}    
  ...
  <div class="col-md-9">
    ...
    <div class="panel">
      <div class="panel-heading">
        <span class="panel-title"> New Activity Group </span>
      </div>
