...
<section class="uk-section uk-booking bg-white uk-position-relative">
    <div class="uk-container uk-container-small"
        ...
        <div class="uk-text-center uk-card uk-card-default uk-card-body uk-border-rounded">
            ...
            <h1 class="uk-h4  uk-margin-remove">Dear<b> {{$name}}</b><p>Thanks for contacting with us!</p></h1>
            <hr class="uk-divider-icon">
            <p><b>Best Wishes</b>
            <br>Seven Summit Treks Pvt. Ltd
            </p>
            <div>
                <a href="{{url('/')}}" class="uk-button button-primary button-primary-active"><b>Home</b></a>
            </div>
        </div>
    </div>
</section>
