...
@section('content')
	...
	uk-parallax="bgy: -100; easing: -2;  " data-src="{{ asset(env('PUBLIC_PATH').'/uploads/team/' . $team->picture) }}" uk-height-viewport="expand: true; min-height: 600;" uk-img>
                   ...
                   <div class="uk-media-350 uk-position-relative">
                      ...
                      <div class="uk-position-center-left uk-margin-small-left uk-social-media-team"> 
                    	<a href="{{$row->fb_url}}" target="_blank"><i class="fa fa-facebook"></i></a>
    					 ...
    					 <a href="{{$row->twitter_url}}" target="_blank"><i class="fa fa-wikipedia-w"></i></a> 
