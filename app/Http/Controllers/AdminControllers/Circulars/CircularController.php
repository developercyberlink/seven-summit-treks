...
class CircularController extends Controller
{
  ...
  public function list($type)
    ...
    public function store(Request $request)
    {
        ...
        $circulartype = $this->getCircular($request->circular_type);
        ...
        $file_name = '';
         if($request->hasfile('circular_thumbnail')){
            ...
            $file_name = Str::slug($product[0]) . '-' . str_random(40) . '.' . $extension;
      ...
      //  $width = Image::make($file->getRealPath())->width();
       // $height = Image::make($file->getRealPath())->height();
        ...
        $data['circular_type'] = $circulartype->id;
    ...
    public function edit(CircularModel $circularModel,$circulartype, $id)
    {
     ...
     return view('admin.circulars.edit', compact('data'));
 }
