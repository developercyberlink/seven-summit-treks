                                ...
                                <?php if(count($book) > 0): ?>
                                    <?php $__currentLoopData = $book; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                       <tr class="bg-light">
                                            ...
                                            <td class=""><?php echo e($row->trips->trip_title); ?><br>
                                             <i class="fa fa-user"></i> <?php echo e(ucfirst($row->name)); ?> <br> 
                                            ...
                                            <td class=""><textarea class="form-control" row="9" readonly><?php echo $row->review; ?></textarea></td>
                                            
                                            <td class=""> <?php if(($row->type)==0): ?>
                                            ...
                                            <td class="text-left">
                                                      <span class="trash">
                                                <a href="<?php echo e(route('delete-inquiry',$row->id)); ?>" onclick="return confirm('Confirm Delete?')" class="btn-btn-danger">Delete</a></span>
                                            </td>
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sevensummittreks/public_html/resources/views/admin/trip-inquiry/index.blade.php ENDPATH**/ ?>