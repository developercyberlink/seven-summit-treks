...
<a href="<?php echo e(route('category.index',$trip_id)); ?>" class="btn btn-primary btn-sm">List</a>
                    ...
                    <div class="card-body">
                        <div class="tab-content">
                                   ...
                                   <div class="form-group">
                                     ...
                                     <div class="col-lg-8">
                                       <div class="bs-component">
                                         <input type="text" id="category" name="category" value="<?php echo e($data->category); ?>" class="form-control" />
                                         ...
                                         <!--            <option <?php if($row->id==$data->id): ?> selected <?php endif; ?>  value="<?php echo e($row->id); ?>"><?php echo e($row->category); ?></option>-->
                            ...
                            <div class="tab-pane" id="tab_2">
                                <?php echo $__env->make('admin.itinerary-category.update-itinerary', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            </div>

                            <div class="tab-pane" id="tab_3">
                                <?php echo $__env->make('admin.itinerary-category.update-cost-include', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            </div>

                            <div class="tab-pane" id="tab_4">
                                <?php echo $__env->make('admin.itinerary-category.update-cost-exclude', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            </div>
...
<?php $__env->startSection('scripts'); ?>
    ...
    jQuery(document).delegate('button.delete-itinerary', 'click', function(e) {
        ...
        if (makeConfirm == true) {
            ...
            var url = '<?php echo e(route('itinerary-category.destroy', ['id' => ':id', 'info_id' => ':info_id'])); ?>';
    ...
    jQuery(document).delegate('button.delete-testimonial', 'click', function(e) {
        ...
        if (makeConfirm == true) {
            ...
            var trip_id = '<?php echo e($data->id); ?>';
            var url ='<?php echo e(route('itinerary-cost-include.destroy', ['id' => ':admin', 'info_id' => ':testimonial'])); ?>';
    ...
    jQuery(document).delegate('button.delete-info', 'click', function(e) {
        ...
        if (makeConfirm == true) {
            ...
            var trip_id = '<?php echo e($data->id); ?>';
            var url = '<?php echo e(route('itinerary-cost-exclude.destroy', ['id' => ':id', 'info_id' => ':info_id'])); ?>';
            url = url.replace(':id', trip_id);
    ...
    $(function() {
        ...
        $("#tripData").on('submit', function(e) {
            ...
            // alert(trip);
            // let url = '<?php echo e(route('itinerary.update', ['trip' => ':trip'])); ?>';
            ...
            data.append('trip_id',<?php echo e($trip_id); ?>);


            $.ajax({
                url: '<?php echo e(route('itinerary.update')); ?>',
                type: 'POST',
                data: data,
                contentType: false,
                cache: false,
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sevensummittreks/public_html/resources/views/admin/itinerary-category/update.blade.php ENDPATH**/ ?>