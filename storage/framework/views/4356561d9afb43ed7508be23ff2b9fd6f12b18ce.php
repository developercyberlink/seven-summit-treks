  ...
  <div class="col-md-9">
    ...
    <div class="panel">
      ...
      <div class="panel-body">                    
         ...
         <label for="inputStandard" class="col-lg-3 control-label">Page Title</label>         
          <div class="col-lg-8">
            <div class="bs-component">
              ...
              <input type="text" id="name" name="page_title" class="form-control" placeholder="Page Title" value="<?php echo e($data->page_title); ?>" required="" />
        ...
        <div class="form-group"> 
         <label for="inputStandard" class="col-lg-3 control-label">Sub Title</label>        
          <div class="col-lg-8">
            <div class="bs-component">
              <input type="text" name="sub_title" class="form-control" placeholder="Sub Title" value="<?php echo e($data->sub_title); ?>" />
            </div>
          </div>
        </div> 
      ...
      <div class="form-group">         
        <div class="col-lg-12">
          <div class="bs-component">
            <textarea class="form-control my-editor"   name="page_excerpt" rows="3"><?php echo e($data->page_excerpt); ?></textarea>
          </div>
        </div>
      </div>
      ...
      <div class="form-group">
        <div class="col-lg-12">
          <div class="bs-component">
            <textarea class="form-control my-editor" name="page_content" rows="6"><?php echo e($data->page_content); ?></textarea>
          </div>
        </div>
      </div>
    ...
    <div class="form-group"> 
         <label for="inputStandard" class="col-lg-3 control-label">Meta Keywords</label>        
          <div class="col-lg-8">
            <div class="bs-component">
              <input type="text" name="meta_keyword" class="form-control" placeholder="Meta Keywords" value="<?php echo e($data->meta_keyword); ?>" />
            </div>
          </div>
        </div>  
        ...
        <div class="form-group"> 
         <label for="inputStandard" class="col-lg-3 control-label">Meta Desription</label>         
          <div class="col-lg-8">
            <div class="bs-component">
              <input type="text" id="email" name="meta_description" class="form-control" placeholder="Meta Desription" value="<?php echo e($data->meta_description); ?>" />
...
<div class="sid_bvijay mb10">
  ...
  <h4> Ordering: </h4>
   <input type="number" name="page_order" class="form-control" placeholder="Ordering" value="<?php echo e($data->page_order); ?>" /> </label>
</div>
  ...
  <div class="hd_show_con">
    <div id="xedit-demo">
       <?php if($data->page_thumbnail): ?>
        ...
        <img src="<?php echo e(asset(env('PUBLIC_PATH').'uploads/original/' . $data->page_thumbnail)); ?>" width="150" />
        <hr>
        </span>             
        <?php endif; ?>   
...
</div><?php /**PATH /home/sevensummittreks/public_html/resources/views/admin/page/edit/edit-general.blade.php ENDPATH**/ ?>