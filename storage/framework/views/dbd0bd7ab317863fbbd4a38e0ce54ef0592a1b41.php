			...
			<div class="uk-width-1-1 uk-position-relative" style="z-index: 99;">
				<div class="uk-container    uk-position-relative" uk-scrollspy="cls: uk-animation-fade;  delay: 500; repeat: false">
					<div class=" uk-margin-medium uk-width-large">
						<h1 class=" uk-text-bolder text-white uk-margin-small" uk-scrollspy="cls: uk-animation-slide-top-small;   delay: 400; repeat: false;"><span class="uk-text-bold">Inquiry</span> </h1> </div>
				</div>
			</div>
		</div>
	</section>
...
<section class="uk-section uk-booking bg-white uk-position-relative">
    <div class="uk-container uk-container-small"
        ...
        <div class="uk-text-center uk-card uk-card-default uk-card-body uk-border-rounded">
            ...
            <h1 class="uk-h3 text-green uk-margin-small uk-text-bold">Contact Success!</h1>
            <h1 class="uk-h4  uk-margin-remove">Dear<b> <?php echo e($name); ?></b><p>Thanks for contacting with us!</p></h1>
...
<?php echo $__env->make('themes.default.common.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sevensummittreks/public_html/resources/views/themes/default/inquiry-success.blade.php ENDPATH**/ ?>