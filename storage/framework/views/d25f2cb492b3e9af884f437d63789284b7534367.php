...
<?php $__env->startSection('breadcrumb'); ?>
    ...
    <a href="<?php echo e(route('pagedoc.create', Request::segment(3))); ?>" class="btn btn-primary btn-sm">Create</a>
                                        ...
                                        <tr class="id<?php echo e($row->id); ?>">
                                            ...
                                            <td class="post_title title_hi_sh">
                                                ...
                                                <div class="row_actions"><span class="id">ID: <?php echo e($row->id); ?> |
                                                        ...
                                                        <a href="<?php echo e(route('pagedoc.edit', ['post_id' => Request::segment(3), 'id' => $row->id])); ?>"
                                                            aria-label="">Edit</a> |
...
<?php $__env->startSection('libraries'); ?>
    <script type="text/javascript">
        $('.row-delete').on('click', function(e) {
            ...
            var url = "<?php echo e(route('pagedoc.delete', ['id' => ':id'])); ?>";
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sevensummittreks/public_html/resources/views/admin/page-doc/index.blade.php ENDPATH**/ ?>