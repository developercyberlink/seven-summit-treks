...
<div class="panel">
  <div class="panel-heading">
   ...
   <div class="panel-body" id="row_highlights_body">
            ...
            <div class="row" id="highlights-rec-1">
  ...
  <div style="display:none;">
      <div id="row_highlights_additional">
        <div class="row">            
            <div class="col-md-1"><input type="number" min="1" max="2000" name="highlights_ordering[]" class="form-control" placeholder="" /></div>
...
<?php /**PATH /home/sevensummittreks/public_html/resources/views/admin/trips/create/create-highlights.blade.php ENDPATH**/ ?>