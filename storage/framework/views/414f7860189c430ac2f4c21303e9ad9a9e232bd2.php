...
<form class="form-horizontal" role="form" action="<?php echo e(url('admin/teamcategory')); ?>" method="post" enctype="multipart/form-data">
  ...
  <div class="admin-form">
    ...
    <div class="sid_bvijay mb10">
      <label class="field text">
        <input type="number" id="inputStandard" name="ordering" class="form-control" value="<?php echo e($ordering); ?>" placeholder="Order" />   
      </label>
    </div>
...
$('.backlink').click(function(){
  ...
  <?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sevensummittreks/public_html/resources/views/admin/team-category/create.blade.php ENDPATH**/ ?>