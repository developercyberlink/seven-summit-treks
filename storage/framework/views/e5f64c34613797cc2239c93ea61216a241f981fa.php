...
<section class="uk-section bg-black-light uk-position-relative " uk-scrollspy="cls: uk-animation-slide-left-small; target:.team__item, .team__title ;  delay: 50; repeat: false;">
		<div class="uk-container uk-container-xsmall">
          ...
          <!--          	<a href="<?php echo e($row->fb_url); ?>" target="_blank"><i class="fa fa-facebook"></i></a>-->
    					 ...
    					 <!--<a href="<?php echo e($row->twitter_url); ?>" target="_blank"><i class="fa fa-twitter"></i></a> -->
...
<?php echo $__env->make('themes.default.common.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sevensummittreks/public_html/resources/views/themes/default/team-international.blade.php ENDPATH**/ ?>