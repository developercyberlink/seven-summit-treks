                                        ...
                                        <tr class="bg-light">
                                           ...
                                           <td class="">
                                             ...
                                             <i class="fa fa-envelope"></i> <?php echo e(($row->email)); ?> <br> 
                                              <i class="fa fa-phone"></i> <?php echo e($row->phone); ?> <br>
                                             <i class="fa fa-flag"></i> <?php echo e(ucfirst($row->country)); ?><br>
                                       
                                                </td>
                                            <td class="">$<?php echo e(($row->input_amount)); ?>  <br>
                                            <?php echo e(($row->paid_status == '1' ? 'Paid' : 'Unpaid')); ?></td>
                                            
                                            <td class=""><textarea class="form-control" row="9" readonly><?php echo $row->comments; ?></textarea></td>
                                              <td class="text-left">
                                                  <span class="trash"><a href="<?php echo e(route('payment.delete',$row->id)); ?>" onclick="return confirm('Confirm Delete?')" class="btn-btn-danger">
                                                   Delete</a></span>
                                              </td>
                                </tr>
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sevensummittreks/public_html/resources/views/admin/payment-index.blade.php ENDPATH**/ ?>