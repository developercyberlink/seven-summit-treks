...
<?php $__env->startSection('content'); ?>
    ...
    <form class="form-horizontal" id="upload_image1" role="form"
        action="<?php echo e(route('pagedoc.update', ['post_id' => Request::segment(3), 'id' => Request::segment(4)])); ?>"
        ...
        <div class="col-md-8">
            ...
            <div class="panel">
                ...
                <div class="panel-body">
                    <input type="hidden" name="page_id" value="<?php echo e(Request::segment(3)); ?>">
...
<?php $__env->startSection('libraries'); ?>
    <script type="text/javascript">
         $('.imagedelete').on('click',function(e){
            ...
            $.ajax({
              type:'delete',
              url:"<?php echo e(url('delete_pagedoc_thumb') . '/'); ?>" + id,
              data:{_token:csrf},    
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sevensummittreks/public_html/resources/views/admin/page-doc/edit.blade.php ENDPATH**/ ?>