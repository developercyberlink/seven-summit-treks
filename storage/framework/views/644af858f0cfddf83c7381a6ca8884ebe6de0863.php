...
<div style="margin:0 auto; max-width:700px; width:100%;">
    ...
    <table>
        ...
        <tr>
            ...
            <td bgcolor="#ddd" ><?php echo e($name); ?> <?php echo e($surname); ?></td>
        </tr>
        <tr>
...
<?php /**PATH /home/sevensummittreks/public_html/resources/views/emails/admin-contactmail.blade.php ENDPATH**/ ?>